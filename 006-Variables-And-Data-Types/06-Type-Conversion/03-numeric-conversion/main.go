...
func main() {
	...
	// We need to convert orange to apple

	// orange is convertable to int because, int and int32 are both numeric types

	apple = int(orange)

	// We can't convert a numeric type to a bool:
	// isDelicious := bool(orange)

	// but we can convert an int to a string
